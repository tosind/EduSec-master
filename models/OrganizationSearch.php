...
class OrganizationSearch extends Organization
{
    ...
    public function rules()
    {
        return [
            ...
            [['org_name', 'org_alias', 'org_address_line1', 'org_address_line2', 'org_phone', 'org_email', 'org_website', 'org_logo', 'org_logo_type', 'org_pic', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'org_name', $this->org_name])
            ...
            ->andFilterWhere(['like', 'org_pic_type', $this->org_pic_type]);
