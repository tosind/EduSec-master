...
class Organization extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['org_name', 'org_alias', 'org_address_line1', 'org_logo_type', 'org_pic_type', 'created_at', 'org_stu_prefix', 'org_emp_prefix'], 'required'],
	    [['org_logo'], 'required', 'on'=>'insert'],
	    [['org_logo'], 'file', 'extensions' => 'jpg, jpeg, gif, png', 'skipOnEmpty' => true, 
'checkExtensionByMimeType'=>false],
            [['org_pic'], 'string'],
            [['org_pic'], 'required', 'on'=>'insert'],
        [['org_pic'], 'file', 'extensions' => 'jpg, jpeg, gif, png', 'skipOnEmpty' => true, 
'checkExtensionByMimeType'=>false],
            [['org_pic'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'org_logo' => Yii::t('app', 'Picture'),
            'org_logo_type' => Yii::t('app', 'Picture Type'),
