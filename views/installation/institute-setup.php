...
<div class="installation-box-body" style="float:left">
	...
	<h2 class="page-header edusec-page-header-1">
		<i class="fa fa-university"></i> School Setup Details
	</h2>
	...
	<div class="col-sm-12 no-padding">
		...
		<!-- <div class="col-sm-6">
		    <div class="col-sm-10 col-xs-12 no-padding">
		    <?= $form->field($model, 'org_pic',['inputOptions'=>['placeholder'=>'School Picture'] ])->fileInput()->label() ?>
		    </div>
		    <div class="col-sm-2 col-xs-12 no-padding">	
		    <?php if(!empty($model->org_pic)) {
				echo Html::img(\Yii::$app->urlManager->createUrl('/site/loadimage'),array('width'=>300,'height'=>300,'alt'=>'No Image'));
			  }
		    ?>
		    </div>
